                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <div className="text-gray-900 dark:text-white font-medium">{profile?.first_name || 'Not set'}</div>
                        </div>
                        <div>
                          <div className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Last Name</div>
                          <div className="text-gray-900 dark:text-white font-medium">{profile?.last_name || 'Not set'}</div>
                        </div>
                      </div>
